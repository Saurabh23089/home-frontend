const Partone = () => {
    return (
        <div className="">
            ...
            <div className="flex overflow-hidden border-2 rounded-lg mx-8 my-8 ">
                ...
                <div className="w-1/3  bg-red-400">
                    ...
                    <div className="flex gap-4 p-8 h-12 mb-4">
                ...
                <div className="flex flex-col justify-center w-2/3">
                    ...
                    <div className="flex items-center  w-full border-b h-16">
                        <div className="flex items-center justify-center gap-4 w-9/12 gap-4">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <div className="bg-gray-100 m-4 h-full rounded-lg">
